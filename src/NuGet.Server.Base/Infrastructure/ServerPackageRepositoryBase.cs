...
namespace NuGet.Server.Infrastructure
{
    ...
    /// </summary>
    public class ServerPackageRepositoryBase
        : PackageRepositoryBase, IServerPackageRepository, IPackageLookup, IDisposable
    {
        ...
        public ServerPackageRepositoryBase(string path, IHashProvider hashProvider, Func<string, bool, bool> getSetting, Logging.ILogger logger)
        {
        ...
        internal ServerPackageRepositoryBase(IFileSystem fileSystem, bool runBackgroundTasks, ExpandedPackageRepository innerRepository, Func<string, bool, bool> getSetting, Logging.ILogger logger = null)
        {
            if (fileSystem == null)
            {
